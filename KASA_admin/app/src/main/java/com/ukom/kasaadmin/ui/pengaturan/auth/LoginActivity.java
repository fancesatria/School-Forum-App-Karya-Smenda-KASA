...
import com.ukom.kasaadmin.databinding.ActivityLoginBinding;
...
public class LoginActivity extends AppCompatActivity {
    ...
    public void prosesLogin(LoginModel loginModel){
        ...
        Call<LoginResponse> loginResponseCall = Api.getRetrofit(LoginActivity.this).loginAdmin(loginModel);
