...
public class DiterimaAdapter extends RecyclerView.Adapter<DiterimaAdapter.ViewHolder> {
    Context context;
    private List<KaryaModel> data;

    public DiterimaAdapter(Context context, List<KaryaModel> data) {
    ...
    @NonNull
    @Override
    public DiterimaAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull DiterimaAdapter.ViewHolder holder, int position) {
        ...
        holder.bind.tanggal.setText("Diterima pada : "+karya.getTgl_verif());
